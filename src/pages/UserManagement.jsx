        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            <h1 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
              <ShieldAlert className="text-indigo-600" /> User Management
            </h1>
            <p className="text-slate-500">
              Verify and approve system access requests.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-white w-full md:w-64"
              value={searchTerm}
