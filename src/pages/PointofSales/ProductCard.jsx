...
const ProductCard = ({ item, onAdd }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-[10px] font-mono font-bold text-blue-700 mb-4 italic">
        SKU: {item.sku}
      </p>
      ...
      <div className="flex gap-2 mb-6">
        <div className="flex flex-1 border-2 border-slate-200 rounded-xl overflow-hidden h-12">
          <button
