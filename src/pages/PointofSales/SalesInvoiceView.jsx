  ...
  return (
    <div className="w-full min-h-screen p-8 bg-white text-slate-900 animate-in fade-in duration-500">
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="print-area border-4 border-black rounded-[2.5rem] overflow-hidden shadow-2xl">
          {/* Header */}
          ...
          <div className="p-10 bg-white">
            ...
            <table className="w-full mb-12">
              <thead>
                <tr className="border-b-4 border-black text-[10px] font-black uppercase">
            ...
            <div className="flex justify-end pt-8 border-t-4 border-black border-double">
              <div className="text-right">
