  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 max-w-full flex">
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col forced-colors:border-l forced-colors:border-[ButtonText]">
          <div className="p-6 border-b flex justify-between items-center text-slate-900 forced-colors:border-[ButtonText]">
              ...
              cart.map((item) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] font-bold italic text-blue-700">
                      Batch: {item.batchNo}
                    </p>
