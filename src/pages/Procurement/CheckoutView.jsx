  ...
  return (
    <div className="w-full min-h-screen p-8 bg-white text-slate-900">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 p-6 bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 no-print">
        ...
        {Object.entries(groupedOrders).map(([supName, items], idx) => {
          ...
          return (
            <div
              key={supName}
              id={`quote-${idx}`}
              className="print-this-only mb-12 border-2 border-black rounded-2xl overflow-hidden shadow-sm"
            >
              {/* Toolbar */}
                ...
                <table className="w-full text-left">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td className="py-4 text-right text-lg font-black underline decoration-2 decoration-blue-500">
                        ₱
                        {items
                          .reduce((sum, i) => sum + i.price * i.quantity, 0)
                          .toLocaleString()}
        ...
        <button
          ...
          className="w-full bg-black text-white py-6 rounded-2xl font-black uppercase tracking-widest no-print mt-4 shadow-xl flex items-center justify-center gap-3 hover:bg-blue-600 transition-colors disabled:opacity-50"
        >
          {isCompleting ? (
